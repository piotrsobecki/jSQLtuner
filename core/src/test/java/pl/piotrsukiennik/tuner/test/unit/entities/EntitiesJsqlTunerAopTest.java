...
public class EntitiesJsqlTunerAopTest extends TestEntities {

    protected static final H2Consumer H2_CONSUMER = H2ConsumerFactory.getH2Consumer( EntitiesJsqlTunerAopTest.class );
