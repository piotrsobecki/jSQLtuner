...
public class EntitiesTestJsqlTunerAop extends TestEntities {

    protected static final H2Consumer H2_CONSUMER = H2ConsumerFactory.getH2Consumer( EntitiesTestJsqlTunerAop.class );
