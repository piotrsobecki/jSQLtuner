...
public class SqlJsqlTunerAopTest extends TestQueries {

    protected static final H2Consumer H2_CONSUMER = H2ConsumerFactory.getH2Consumer( SqlJsqlTunerAopTest.class );
