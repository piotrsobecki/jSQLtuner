...
import pl.piotrsukiennik.tuner.service.ReadQueryInvalidatonVisitor;
 ...
 */
@Service
class ReadQueryInvalidatonVisitorImpl implements ReadQueryInvalidatonVisitor<ReadQuery> {
