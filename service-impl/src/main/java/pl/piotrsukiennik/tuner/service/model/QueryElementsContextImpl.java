 ...
 * Time: 19:26
 */
public class QueryElementsContextImpl implements QueryElementsContext {
    ...
    QueryElementsContextImpl( SchemaService schemaService, QueryElementsService elementService, String database, String schema ) {
    ...
    QueryElementsContextImpl( SchemaService schemaService, QueryElementsService elementService, QueryElementsCache queryElementsCache ) {
