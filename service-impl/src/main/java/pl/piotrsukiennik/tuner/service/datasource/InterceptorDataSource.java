...
import pl.piotrsukiennik.tuner.service.AbstractDataSource;
...
public abstract class InterceptorDataSource extends AbstractDataSource {
    ...
    private static final String GET_DATA_EXCEPTION_FORMAT = "InterceptorDataSource does not support query %s.";
