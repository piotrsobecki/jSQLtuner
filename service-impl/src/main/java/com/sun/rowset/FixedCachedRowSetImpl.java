...
public class FixedCachedRowSetImpl extends CachedRowSetImpl {
    ...
    private static final String CRSI_ICNM = "cachedrowsetimpl.invalcolnm";
    ...
    private int getColIdxByName( String name ) throws SQLException {
        ResultSetMetaData rowSetMetaData =  this.getMetaData();
        ...
        throw new SQLException( resBundle.handleGetObject( CRSI_ICNM ).toString() );
    }
